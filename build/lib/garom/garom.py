...
class Generator(nn.Module):
    def __init__(self, input_dimension, parameters_dimension, hidden_dimension,noise_dimension, activation=torch.nn.SiLU):
        super().__init__()
        ...
        self.model = torch.nn.Sequential(
            torch.nn.Linear(6 * self._noise_dimension, hidden_dimension),
            self._activation(),
...
class Discriminator(nn.Module):
    def __init__(self, input_dimension, parameter_dimension,
        ...
        self.decoding = torch.nn.Sequential(
            torch.nn.Linear(2*hidden_dimension, hidden_dimension),
            self._activation(),
            torch.nn.Dropout(0.3),
            torch.nn.Linear(hidden_dimension, hidden_dimension),
            self._activation(),
        ...
        self.condition = torch.nn.Sequential(
            torch.nn.Linear(parameter_dimension, hidden_dimension),
            self._activation(),
            torch.nn.Linear(hidden_dimension, hidden_dimension)
        )
...
class GAROM(object):
    ...
    def __init__(self, input_dimension, hidden_dimension,
        ...
        self._generator = Generator(input_dimension=input_dimension,
                                    parameters_dimension=parameters_dimension,hidden_dimension=hidden_dimension,
                                    noise_dimension=noise_dimension)

        # setting discriminator
        self._discriminator = Discriminator(input_dimension=input_dimension,parameter_dimension=parameters_dimension,hidden_dimension=hidden_dimension)
    ...
    def fit(self,parameter,value):
        x=torch.tensor(parameter).float()
    ...
    def predict(self,parameter):   
        ...
        return self.estimate(parameter)
